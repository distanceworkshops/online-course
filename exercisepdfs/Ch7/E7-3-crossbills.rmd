...
answer <- FALSE
```
# Conducting dual surveys: fitting GLMs and bootstrapping
...
ggplot(data=preddata, aes(x=dist, y=pi.r)) + geom_point(size=0.6) +
  labs(title="Assumed density of birds") +
...
__Analysis of main survey data__
...
```{r boothist, echo=TRUE, eval=answer, fig.margin=TRUE, fig.cap="Distribution of abundance estimates from bootstrap.", message=FALSE}
alpha <- 0.05
