...
Note there is no `Area` field in the dataset.  The analysis can be conducted just fine, and bird density can be estimated, but bird abundance cannot be estimated. The latter three columns are the covariates to be considered for possible inclusion into the detection function. 
...
```{r, echo=FALSE, eval=answer, fig.width=2, fig.height=2, fig.margin=TRUE,results='hold',fig.cap="Two levels of detail examining distribution of detection distances.", results='hide', message=FALSE}
library(ggplot2)
