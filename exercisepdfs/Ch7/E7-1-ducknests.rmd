...
The `convert.units` argument ensures that the correct units are specified - in this example, distances are in metres, lengths in km and the area in km$^2$.  Think of this argument as a divider used to transform units of transect effort into units of perpendicular distance (e.g., 5km / 0.001 = 5000m).
