...
This practical is based on the Montrave songbird case study in \citet[Ch. 5]{buckland_distance_2015}, with computer code under [Montrave songbird case study](https://synergy.st-andrews.ac.uk/ds-manda/#montrave-songbird-case-study). Both point and line transect surveys were conducted and here we use the data from the __line transect__ data, although the issues (and solutions) will be similar. 
...
```{r, echo=TRUE, eval=answer, message=F, fig.height=3.5, fig.width=3.5, fig.margin=TRUE}
